...
```{r Difining manufacturer for every host}
...
## Оценка результата
 ...
 В результате лабораторной работы мы проанализировали трафик, используя dplyr и статистический анализ.

## Вывод

Таким образом, мы:
- получили знания о методах исследования радиоэлектронной обстановки;
- составили представление о механизмах работы Wi-Fi сетей на канальном и сетевом уровне модели OSI;

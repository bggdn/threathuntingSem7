...
столбцов в соответствии с типом данных и посмотреть с помощью `glimpse`.
...
5 Выявить устройства, использующие последнюю версию протокола шифрования
...
![](Lab5.markdown_strict_files/figure-markdown_strict/Clasterization-1.png)
...
![](Lab5.markdown_strict_files/figure-markdown_strict/Clasterization-2.png)
...
dplyr и статистический анализ.

## Вывод

Таким образом, мы: - получили знания о методах исследования
радиоэлектронной обстановки; - составили представление о механизмах
работы Wi-Fi сетей на канальном и сетевом уровне модели OSI; - закрепили
практические навыки использования языка программирования R для обработки
данных; - закрепили знания основных функций обработки данных экосистемы
tidyverse языка R.
